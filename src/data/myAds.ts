import { UploadFormFields } from "./typs";

export interface MyAd extends UploadFormFields {
  id: string;
  location: string;
  postedAt: string;
  views: number;
...
export const MOCK_MY_ADS: MyAd[] = [
  ...
  },
  {
    ...
    price: "1800000",
    description: "استوديو عصري ومريح قريب من الخدمات.",
    videos: [],
    propertyStatus: null,
    termsAccepted: true,
    propertyType: "resedencial",
  ...
  },
  {
    ...
    price: "5200000",
    description: "فيلا عائلية واسعة مع مساحات مناسبة للسكن.",
    videos: [],
    propertyStatus: "ready",
    termsAccepted: true,
