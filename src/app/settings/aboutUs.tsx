        ...
        <ScrollView>
          <View className="gap-4 px-5 pt-8 pb-6">
            ...
            <Text className="text-base leading-8 text-left text-[#374151]">
              مسكن هو تطبيق سوداني يهدف إلى تسهيل طريقة البحث عن السكن والعقارات
              ...
              إلى العقار المناسب له بسهولة وأمان. بدأت فكرة مسكن من مشكلة
              نواجهها بأنفسنا كطلاب وأسر وأفراد في السودان؛ فالبحث عن مسكن
              غالبًا ما يعتمد على السؤال والمعارف ومجموعات الواتساب والفيسبوك،
              مما يجعل العملية تستغرق وقتًا وجهدًا ومالًا. نريد أن نجعل هذه
              التجربة أسهل، ونبدأ بخطوة نحو مستقبل تقني أفضل للسودان.
            </Text>
          </View>
          ...
          <View className="gap-4 px-5 py-8 mx-4 mt-2 bg-blue-400/30 rounded-2xl">
            ...
            <Text className="text-base leading-8 text-left text-[#0F113C]">
              مسكن لم يُبنَ بهدف الربح، بل بُني أولًا لخدمة الناس. نحن نؤمن أن
              ...
              مسكن من مشكلة حقيقية نعيشها نحن كطلاب وأسر وأفراد في السودان، وهي
              صعوبة البحث عن مسكن مناسب، وما يصاحب ذلك من وقت وجهد وتكاليف وطرق
              ...
              التقليدية. نحن لا نريد أن يكون مسكن مجرد تطبيق آخر، بل نطمح أن
              يكون حلًا سودانيًا لمشكلة سودانية، وأن نثبت أن الأفكار التقنية
              البسيطة يمكن أن تصنع فرقًا حقيقيًا في حياة الناس. مسكن — تقنية
              سودانية لحياة أسهل.
            </Text>
          </View>
