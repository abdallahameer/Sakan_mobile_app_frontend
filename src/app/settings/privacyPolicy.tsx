...
export default function PrivacyPolicy() {
  ...
  return (
    <View className="flex-1 bg-[#F0F1FA]">
      {/* Header */}
      <SafeAreaView>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerClassName=" pb-10">
        <SafeAreaView className=" px-2.5" style={{ flex: 1 }}>
          ...
          <View className="mb-6">
            ...
            <Text className="mb-2 text-base leading-7 text-left text-[#374151]">
              يتم استخدام هذه المعلومات لعرض العقار للمستخدمين وتمكين المهتمين
              من التواصل مع صاحبه.
            </Text>
          </View>
          ...
          <View className="mb-6">
            ...
            <Text className="mb-2 text-base leading-7 text-left text-[#374151]">
              يتم تخزين الصور باستخدام البنية التحتية والخدمات السحابية
              المستخدمة لتشغيل التطبيق.
            </Text>
            <Text className="mb-2 text-base leading-7 text-left text-[#374151]">
          ...
          <View className="mb-6">
            ...
            <Text className="mb-2 text-base leading-7 text-left text-[#374151]">
              قد يطلب التطبيق من المستخدم تقديم مستند يثبت ملكية العقار أو حقه
              في عرضه.
            </Text>
            <Text className="mb-2 text-base leading-7 text-left text-[#374151]">
            ...
            <Text className="mb-2 text-base leading-7 text-left text-[#374151]">
              ...
              بذلك، ويتم التعامل معها وفقًا لسياسة حماية البيانات والأمان
              المعمول بها.
            </Text>
          </View>
          ...
          <View className="mb-6">
            ...
            <Text className="mb-2 text-base leading-7 text-left text-[#374151]">
              قد يختار المستخدم إضافة موقع جغرافي للعقار باستخدام الخريطة، وفي
              هذه الحالة قد يتم عرض موقع العقار للمستخدمين الآخرين.
            </Text>
          </View>
          ...
          <View className="mb-6">
            ...
            <Text className="mb-2 text-base leading-7 text-left text-[#374151]">
              ...
              قاعدة بيانات التطبيق حتى يتمكن المستخدم من الوصول إلى العقارات
              التي حفظها لاحقًا.
            </Text>
          </View>
          ...
          <View className="mb-6">
            ...
            <Text className="mb-2 text-base leading-7 text-left text-[#374151]">
              ...
              المستخدمين من الوصول غير المصرح به أو التعديل أو الكشف أو
              الاستخدام غير المشروع.
            </Text>
            <Text className="mb-2 text-base leading-7 text-left text-[#374151]">
              يستخدم التطبيق اتصال HTTPS للمساعدة في حماية البيانات أثناء
              انتقالها بين الجهاز والخوادم.
            </Text>
            <Text className="mb-2 text-base leading-7 text-left text-[#374151]">
          ...
          <View className="mb-6">
            ...
            <Text className="mb-2 text-base leading-7 text-left text-[#374151]">
              بعد انتهاء الحاجة القانونية أو الأمنية للاحتفاظ بهذه المعلومات،
              يتم حذفها أو جعلها غير قابلة للربط بالمستخدم، وفقًا لما تسمح به
          ...
          <View className="mb-6">
            ...
            <Text className="mb-2 text-base leading-7 text-left text-[#374151]">
              ...
              مخالفة للقوانين المعمول بها، فسنتخذ الإجراءات المناسبة لمعالجة
              ذلك.
            </Text>
          </View>
          ...
          <View className="mb-6">
            ...
            <Text className="mb-2 text-base leading-7 text-left text-[#374151]">
              ومع ذلك، يجب على المستخدم دائمًا التحقق بنفسه من صحة معلومات
              العقار وملكية العقار قبل إجراء أي عملية مالية أو قانونية.
            </Text>
          </View>
          ...
          <View className="mb-6">
            ...
            <Text className="mb-2 text-base leading-7 text-left text-[#374151]">
              أي محادثات أو معلومات يتم تبادلها من خلال خدمات خارجية مثل
          ...
          <View className="mb-6">
            ...
            <Text className="mb-2 text-base leading-7 text-left text-[#374151]">
              ...
              الصفحة، وقد نستخدم وسائل مناسبة لإبلاغ المستخدمين بالتغييرات
              المهمة.
            </Text>
            <Text className="mb-2 text-base leading-7 text-left text-[#374151]">
          ...
          <View className="mb-6">
            ...
            <Text className="mb-2 text-base leading-7 text-left text-[#374151]">
              ...
              البيانات الشخصية، فسيتم تحديث سياسة الخصوصية هذه لتوضيح طريقة
              التعامل مع البيانات المتعلقة بهذه الميزات.
            </Text>
          </View>
        ...
        {/* Footer */}
        <View className="w-full flex-col items-center pt-5  pb-10 justify-start gap-5 bg-[#0F113C] h-[20%]">
